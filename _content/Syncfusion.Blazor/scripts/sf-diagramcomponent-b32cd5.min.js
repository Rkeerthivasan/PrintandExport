        ...
        applyStyleAgainstCsp:function applyStyleAgainstCsp(svg, attributes) {
            ...
            for (var i = 0; i < keys.length; i++) {
                ...
                if (attribute.length === 2) {
                    ...
                    exportDiagram: function (options, diagramId, pbounds, pageSettings) {
                        return __awaiter(this, void 0, void 0, function () {
                            var fileType, customBounds, content, content1, data, buffers, margin, region, mode, bounds, fileName, svg, svgData, buffer, browserInfo, b, blob, pom, url, e;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        content1 = '';
                                        ...
                                        region = options && options.region==0 ? "PageSettings" : 'Content';
                                        mode = options && options.mode ? options.mode : 'Download';
                                        bounds = pbounds;
                                        var pbbounds = new Rect(pbounds.x, pbounds.y, pbounds.width, pbounds.height);
                                        if (options.bounds) {
                                            customBounds = true;
                                        ...
                                        return [4, this.setCanvas(options, bounds, pbbounds, margin, mode, customBounds, region, fileName, pageSettings, diagramId)];
                                    case 1:
                                        data = _a.sent();
                                        if (data !== null) {
                                            return [2, data];
                                        ...
                                        if (mode === 'Download' && data !== null) {
                                            ...
                                            for (b = 0; b < buffers.length; b++) {
                                                ...
                                                if (sf.base.Browser.info.name === 'msie') {
                                                    ...
                                                    pom = this.createHtmlElement('a', { 'download': fileName + '.' + fileType });
                    ...
                    setCanvas: function (options, bounds, pbounds, margin, mode, customBounds, region, fileName, pageSettings, diagramId) {
                        return __awaiter(this, void 0, void 0, function () {
                            var content, scaleX, scaleY, scaleOffsetX, scaleOffsetY, canvas, image, storeFormat, pagebounds;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        options.bounds = bounds;
                                        options.region = region;
                                        var pagebounds = new Rect(pbounds.x, pbounds.y, pbounds.width, pbounds.height);
                                        scaleX = 'scaleX';
                                        scaleY = 'scaleY';
                                        scaleOffsetX = 'scaleOffsetX';
                                        scaleOffsetY = 'scaleOffsetY';
                                        var updatedbounds = new Rect(bounds.x, bounds.y, bounds.width, bounds.height);
                                        this.setScaleValueforCanvas(options, bounds, pageSettings);
                                        return [4, this.exportAsImage({
                                        ...
                                        }, fileName, diagramId, options.format, options.mode, pagebounds, updatedbounds, pageSettings, mode === 'Download')];
                                    case 1:
                                        canvas = _a.sent();
                                        ...
                                        //}
                                        var value = diagram.getfileFormats(options.format);
                                        image = content = storeFormat = (options.format === 0) ? canvas.toDataURL('image/jpeg') :
                                            (options.format === 1) ? canvas.toDataURL('image/png') : (options.format === 3) ? canvas.toDataURL('image/bmp') : canvas.toDataURL();
                                        if (mode === 'Data') {
                                            return [2, content];
                                        }
                                        this.canvasMultiplePage(options, canvas, margin, image, fileName, diagramId, pageSettings);
                                        return [2, null];
                                }
                            });
                        });
                    },
                    exportAsImage: function (options, fileName, element, format, mode, pageBounds, updatedbounds, pageSettings, isReturnBase64) {
                        return __awaiter(this, void 0, void 0, function () {
                            var returnValue;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4, this.imageExport(options, fileName, element, format, mode, pageBounds, updatedbounds, pageSettings, isReturnBase64)];
                                    case 1:
                                        returnValue = _a.sent();
                    ...
                    imageExport: function (options, fileName, elementId, format, mode, pageBounds, updatedbounds, pageSettings, isReturnBase64) {
                        return __awaiter(this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                ...
                                promise = new Promise(function (resolve, reject) {
                                    ...
                                    var bgColor = pageSettings.background.color;
                                    ...
                                    diagram.setAttributeSvg(svgData, attr);
                                    attr = {
                                        'x': String(left),
                                    ...
                                    if (backgroudImage) {
                                        ...
                                        diagram.setAttributeSvg(backgroudImage, attr);
                                        svgData.appendChild(backgroudImage);
                                        if (options.region === 'Content')
                                        {
                                            diagram.setTransform(backgroudImage, pageBounds, margin);
                                            for (var i = 0; i < backgroudImage.childNodes.length; i++) {
                                                ...
                                                if (element.id === elementId + '_backgroundImageLayer' || element.id === elementId + '_backgroundLayer') {
                                                    diagram.setTransform(element, pageBounds, margin);
                                                }
                                            }
                                        }
                                    }
                                    //diagram.setAttributeSvg(diagramLayer, attr);
                                    svgData.appendChild(diagramLayer);
                                    if (options.region === 'Content') {
                                        diagram.setTransform(diagramLayer, pageBounds, margin);
                                    ...
                                    if (format === 2) {
                                        //_this.triggerDownload('SVG', fileName, url);
                                        //resolve(null);
                                        var svg;
                                        if (mode === 1) {
                                            if (options.format === 'SVG') {
                                        ...
                                        canvasElement_1.height = options.bounds.height;
                                        canvasElement_1.width = options.bounds.width;
                                        var context_1 = canvasElement_1.getContext('2d');
                                        if (options.region === 'PageSettings') {
                                            context_1.translate(-region.x, -region.y);
                                            context_1.save();
                                            context_1.fillStyle = (pageSettings.background.background === 'transparent') ? 'white' :
                                                pageSettings.background;
                                            region = options.region === 'Content' ? pageBounds : region;
                                            context_1.fillRect(region.x, region.y, region.width, region.height);
                                        }
                                        else {
                                            context_1.fillStyle = (pageSettings.background.background === 'transparent') ? 'white' :
                                                pageSettings.background;

                                            context_1.fillRect(0, 0, options.bounds.width, options.bounds.height);
                                        }

                                        //var bgImg = pageSettings.background;
                                        ...
                                        //        }
                                        //        if (pageSettings.background.color === 'none' || pageSettings.background.color === 'transparent') {
                                        //            context_1.fillStyle = 'white';
                                        //            context_1.fillRect(pageBounds.x * options[scaleX], pageBounds.y * options[scaleY], pageBounds.width * options[scaleX], pageBounds.height * options[scaleY]);
                                        //        }
                                        //        if (exportable) {
                                        //            context_1.drawImage(image, x, y, proportion * image.width, proportion * image.height);
                                        //        }
                                        //    }
                                        //    else if (exportable) {
                                        //        context_1.drawImage(image, x, y, pageBounds.width, pageBounds.height);
                                        //    }
                                        //}
                                        //else {
                                        //    context_1.fillStyle = bgColor === 'transparent' ? 'white' : bgColor;
                                        //    context_1.fillRect((pageBounds.x * options[scaleX]) - margin.left, (pageBounds.y * options[scaleY]) - margin.top, (pageBounds.width * options[scaleX]) + margin.left + margin.right, (options[scaleY] * pageBounds.height) + margin.top + margin.bottom);
                                        //}
                                        //var brColor = pageSettings.background.color;
                                        //var brWidth = pageSettings.width;
                                        //if (brWidth) {
                                        //    context_1.strokeStyle = brColor === 'none' ? 'transparent' : brColor;
                                        //    context_1.lineWidth = brWidth;
                                        //    context_1.strokeRect(pageBounds.x * options[scaleX], pageBounds.y * options[scaleY], pageBounds.width * options[scaleX], pageBounds.height * options[scaleY]);
                                        //}
                                        //context_1.restore();
                                        ...
                                        image_1.onload = function () {
                                            ...
                                            context_1.drawImage(image_1, 0, 0, width, height);
                                            window.URL.revokeObjectURL(url);
                                            var value = diagram.getfileFormats(format);
                                            var base64String = canvasElement_1;
                                            //var base64String = (format=== 0) ? canvasElement_1.toDataURL('image/jpeg') :
                                            //    (format === 1) ? canvasElement_1.toDataURL('image/png') : (format === 3) ? canvasElement_1.toDataURL('image/bmp') : canvasElement_1;
                    ...
                    getfileFormats: function getfileFormats(key) {
                        return fileFormats[key];
                    },
                    ...
                    canvasMultiplePage: function (options, canvas, margin, image, fileName, diagramId, pageSettings) {
                        var _this = this;
                        var images = [];
                        ...
                        if (options.multiplePage) {
                            ...
                            img_1.onload = function () {
                                images = _this.getMultipleImage(img_1, options, diagramId, true, pageSettings);
                    ...
                    setScaleValueforCanvas: function (options, bounds, pageSettings) {
                        ...
                        var pageOrientation = options.pageOrientation || pageSettings.orientation;
                        if (!pageOrientation) {
                    ...
                    diagramAsSvg: function (options, margin) {
                        var svg;
                        document.body.appendChild(svg);
                        var g = dom_util_1.createSvgElement('g', { 'id': diagramId + '_pageBackground' });
                        ...
                        dom_util_1.setAttributeSvg(g, attr);
                        this.setTransform(g, options.bounds, margin);
                        var gradient = document.getElementById(diagramId + 'gradient_pattern');
                        if (gradient) {
                        ...
                        var backimage = document.getElementById(diagramId + '_backgroundImageLayer').cloneNode(true);
                        dom_util_1.setAttributeSvg(backimage, attr);
                        svg.appendChild(backimage);
                        this.setTransform(backimage, bounds, margin);
                        var backRect = document.getElementById(diagramId + '_backgroundLayerrect').cloneNode(true);
                        dom_util_1.setAttributeSvg(backRect, attr);
                        svg.appendChild(backRect);
                        this.setTransform(backRect, bounds, margin);
                        if (options.mode === 'SVG') {
                            var element = void 0;
                            var i = void 0;
                            var diagramLayerSVG = dom_util_1.getDiagramLayerSvg(diagramId);
                            for (i = 0; i < svg.childNodes.length; i++) {
                                element = svg.childNodes[i];
                                if (element.id === diagramId + '_diagramLayer') {
                                    this.setTransform(element, bounds, margin);
                                }
                            }
                        }
                        else {
                            g = dom_util_1.createSvgElement('g', { 'id': diagramId + '_diagramLayer' });
                            svg.appendChild(g);
                            this.setTransform(g, options.bounds, margin);
                            var renderer = new src_1.DiagramRenderer('', null, true);
                            var htmlLayer = dom_util_1.getHTMLLayer(diagramId);
                        }
                    ...
                    diagramAsCanvas: function (options, customBounds) {
                        var scaleX = 'scaleX';
                        var scaleY = 'scaleY';
                        var scaleOffsetX = 'scaleOffsetX';
                        var scaleOffsetY = 'scaleOffsetY';
                        ...
                        var bgColor = pageSettings.background.color;
                        var canvas = this.createCanvas(diagramId + '_diagram', options.bounds.width, options.bounds.height);
                        var context = canvas.getContext('2d');
                        context.translate(-region.x, -region.y);
                        context.save();
                        context.fillStyle = (pageSettings.background.color === 'transparent') ? 'white' :
                        ...
                        context.restore();
                        var htmlLayer = dom_util_1.getHTMLLayer(diagramId);
                        var renderer = new src_1.DiagramRenderer('', null, false);
                    ...
                    updateWrapper: function (canvas, value, scaleOffsetX, scaleOffsetY, isExport) {
                    ...
                    scaleGradientValue: function (node, scaleValue, isExport) {
                        if (node.style.gradient.stops.length > 0) {
                            var gradients = node.style.gradient;
                            if (node.style.gradient instanceof src_1.LinearGradient) {
                    ...
                    updateObjectValue: function (value, scaleOffsetX, scaleOffsetY, isExport) {
                    },
                    isImageExportable: function (backgroundImage) {
                        ...
                        if (backgroundImage.source) {
                            try {
                                canvas = this.createCanvas(diagramId + 'temp_canvas', 100, 100);
                    ...
                    getMultipleImage: function (img, options, diagramId, isExport, pageSettings) {
                        var imageArray = [];
                        ...
                        if (options && options.multiplePage) {
                            ...
                            do {
                                do {
                                    ...
                                    canvas.background = (pageSettings.background.background === 'transparent') ? 'white' : pageSettings.background;
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        pageSettings = pageSettings;
                                        diagramId = diagramId;
                                        return [4, this.exportDiagram(options, diagramId, bounds, pageSettings)];
                                    case 1:
                                        url = _a.sent();
                                        this.printImages(url, options, diagramId, pageSettings);
                                        return [2, url];
                                }
                            });
                        });
                    },
                    printImages: function (url, options, diagramId, pageSettings) {
                        var _this = this;
                        var attr = {
                            'id': diagramId + '_printImage',
                            'src': url
                        ...
                        var img = this.createHtmlElement('img', attr);
                        img.onload = function () {
                            var div = _this.getMultipleImage(img, options, diagramId,false, pageSettings);
