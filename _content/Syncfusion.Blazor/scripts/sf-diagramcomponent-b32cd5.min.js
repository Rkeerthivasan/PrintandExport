            ...
            for (var i = 0; i < keys.length; i++) {
                ...
                if (attribute.length === 2) {
                    ...
                    exportDiagram: function (options, diagramId, pbounds, pageSettings) {
                        return __awaiter(this, void 0, void 0, function () {
                            var _this = this;
                            var fileType, content, content1, data, buffers, margin, region, mode, bounds, fileName, svg, svgData, buffer, browserInfo, b, blob, pom, url, e;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        content1 = '';
                                        ...
                                        options.region = options && options.region == 0 ? 'PageSettings' : 'Content';
                                        options.mode = options && options.mode == 0 ? 'Download' : 'Data';
                                        options.format = options && options.format === 0 ? 'JPG' :
                                            (options.format === 1) ? 'PNG' : options.format === 2 ? 'SVG' : (options.format === 3) ? 'BMP' : options.format;
                                        bounds = pbounds;
                                        ...
                                        return [4, this.setCanvas(options, bounds, pbbounds, margin, fileName, pageSettings, diagramId)];
                                    case 1:
                                        data = _a.sent();
                                        if (data !== null) {
                                            //var attr = {
                                            ...
                                            //img.onload = function () {
                                            //    var div = _this.getMultipleImage(img, options, diagramId, true, pageSettings);
                                            //    return [2, div];
                                            //};
                                            return [2, data];
                                        }
                                ...
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4, this.exportAsImage({
                                            bounds: bounds, margin: margin, region: options.region, scaleX: options[scaleX],
                                    ...
                                    case 1:
                                        canvas = _a.sent();
                                        image = content = storeFormat = (options.format === 'JPG') ? canvas.toDataURL('image/jpeg') :
                    ...
                    exportAsImage: function (options, fileName, diagramId, updatedoptions, pageBounds, updatedbounds, pageSettings, isReturnBase64) {
                        return __awaiter(this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4, this.imageExport(options, fileName, diagramId, updatedoptions, pageBounds, updatedbounds, pageSettings, isReturnBase64)];
                                    case 1:
                                        returnValue = _a.sent();
                        ...
                        return __awaiter(this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                ...
                                promise = new Promise(function (resolve, reject) {
                                    ...
                                    if (backgroudImage) {
                                        if (updatedoptions.region === 'Content')
