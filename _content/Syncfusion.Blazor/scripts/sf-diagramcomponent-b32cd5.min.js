                            ...
                            return __generator(this, function (_a) {
                                ...
                                promise = new Promise(function (resolve, reject) {
                                    return __awaiter(_this, void 0, void 0, function () {
                                        var data, buffers, margin, bounds, pbbounds, fileName, attr, img;
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0:
                                                    data = 'data';
                                                    ...
                                                    options.region = options && options.region == 0 ? 'PageSettings' : options.region == 1 ? 'Content' : options.region;
                                                    options.fileName = name;
                                                    options.mode = isbase64 ? 'Download' : 'Data';
                                                    options.format = fileformat && fileformat === 0 ? 'JPG' :
                                                    ...
                                                    if (options.clipBounds) {
                                                        bounds.x = options.clipBounds.x ? options.clipBounds.x : bounds.x;
                                                        bounds.y = options.clipBounds.y ? options.clipBounds.y : bounds.y;
                                                    ...
                                                    return [4, instance.setCanvas(options, bounds, pbbounds, margin, fileName, pageSettings, diagramId)];
                                                case 1:
                                                    data = _a.sent();
                                                    if (data !== null) {
                                                        if (canPrint) {
                                                            ...
                                                            img = this.createHtmlElement('img', attr);
                                                            img.onload = function () {
                                ...
                                promise = new Promise(function (resolve, reject) {
                                    ...
                                    if (updatedoptions.format === 'SVG') {
                                        ...
                                        if (updatedoptions.region === 'PageSettings') {
                                            ...
                                            context_1.fillRect(0,0, options.clipBounds.width, options.clipBounds.height);
                                        }
                        ...
                        if (options && options.fitToPage) {
                            ...
                            do {
                                do {
                                    ...
                                    //canvas.background = (pageSettings.background.background === 'transparent') ? 'white' : pageSettings.background.background;
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        pageSettings = pageSettings;
                                        diagramId = diagramId;
                                        return [4, this.exportDiagram(options, diagramId, bounds, pageSettings,true)];
                                    case 1:
                                        url = _a.sent();
