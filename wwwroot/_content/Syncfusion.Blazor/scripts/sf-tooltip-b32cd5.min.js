...
/******/ 	return __webpack_require__(__webpack_require__.s = "./bundles/sf-tooltip.js");
/******/ })
/************************************************************************/
/******/ ({
  ...
  var SfTooltip = function () {
    ...
    SfTooltip.prototype.checkForOpen = function (opensOn, element, e) {
      ...
      if (opensOn === 'Hover') {
        ...
        if (element === sf.base.closest(e.target, '.' + ROOT) && sf.base.getAttributeOrDefault(target, 'data-tooltip-id', null) === null) {
          isOpenable = true;
        } else {
          isOpenable = false;
        }
    ...
    SfTooltip.prototype.showTooltip = function (target, showAnimation, e) {
      ...
      var show = function show() {
        ...
        _this.element.eventList.beforeRender ? _this.triggerEvent('TriggerBeforeRenderEvent', _this.tooltipEventArgs) : _this.beforeRenderCallBack(false);
      };
    ...
    SfTooltip.prototype.hideTooltip = function (hideAnimation, e, targetElement) {
      ...
      var hide = function hide() {
        ...
        _this.element.eventList.beforeClose ? _this.triggerEvent('TriggerBeforeCloseEvent', _this.tooltipEventArgs) : _this.beforeCloseCallBack(false);
      };
